				...
				<table class="table table-bordered" style="margin-bottom:0px;">
					<tbody>
						<tr>
							...
							<td width="320px">
							{{if status=='unchecked'}}
								<a href="../views/videoPublishEdit.jsp?id={{:id}}" data-fancybox-type="iframe" class="btn-edit linkbtn">编辑</a>
								<a onclick="changeStatus(this)" data-id="{{:id}}" data-url="../rest/videopublish/changeStatus?status=checked&id={{:id}}" class="linkbtn">审核</a>
								<a onclick="changeStatus(this)" data-id="{{:id}}" data-url="../rest/videopublish/delete?id={{:id}}" class="linkbtn">删除</a>
							{{else status=='checked'}}
								<a onclick="changeStatus(this)" data-id="{{:id}}" data-url="../rest/videopublish/changeStatus?status=unchecked&id={{:id}}" class="linkbtn">取消审核</a>
								<a onclick="changeStatus(this)" data-id="{{:id}}" data-url="../rest/videopublish/delete?id={{:id}}" class="linkbtn">删除</a>
							{{/if}}
							</td>
						</tr>
