...
<script id="queboxTpl" type="text/template">
						...
						<tr>
							...
							<td width="auto" style="color:#f00;font-size:18px;">&yen;{{:price}}</td>
							<td width="auto" style="color:#999;">{{:creator}}</td>
							<td width="auto" style="color:#999;">{{:createtimeCN}}</td>
							<td width="320px">
							<a href="../views/commodityEdit.jsp?id={{:id}}" data-fancybox-type="iframe" class="btn-edit linkbtn" style="margin-top:0;">编辑</a>
							<a onclick="changeStatus(this)" data-id="{{:id}}" data-url="../rest/commodity/remove?id={{:id}}" class="linkbtn linkbtndel" style="margin-top:0;">删除</a>
							</td>
						</tr>
